 ...
 */
class EditLawyerServicePresenter(context: Context, view: EditLawyerServiceContract.View) :
    HMBasePresenter<EditLawyerServiceContract.View>(context, view),
    EditLawyerServiceContract.Presenter {
