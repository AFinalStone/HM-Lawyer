 ...
 */
class LawyerLetterOrderListPresenter(context: Context, view: LawyerLetterOrderListContract.View) :
    HMBasePresenter<LawyerLetterOrderListContract.View>(context, view),
    LawyerLetterOrderListContract.Presenter {
    companion object {
